...
//
//     try {
//       return (await auth.createUserWithEmailAndPassword(email: email, password: password)).user;
//     } catch (e) {
...
//     FirebaseAuth auth = FirebaseAuth.instance;
//     try {
//       return (await auth.signInWithEmailAndPassword(email: email, password: password)).user;
//     } catch (e) {
//       print('Exception @createAccount: $e');
//       ShowToastError(message: AuthExceptionHandler.generateExceptionMessage(e));
//       return null;
